...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {   
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 7000, function(sym, e) {
         var count1 = sym.getVariable("count1");
         sym.setVariable("count1", count1 + 1 );
         if(count1 < 6) {
         	sym.play("start");
         }
   ...
   (function(symbolName) {   
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 7000, function(sym, e) {
         var count2 = sym.getVariable("count2");
         sym.setVariable("count2", count2 + 1 );
         if(count2 < 6) {
         	sym.play("start2");
         }
   ...
   (function(symbolName) {   
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 7000, function(sym, e) {
         var count3 = sym.getVariable("count3");
         sym.setVariable("count3", count3 + 1 );
         if(count3 < 6) {
         	sym.play("start3");
         }
   ...
   (function(symbolName) {   
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 7000, function(sym, e) {
         var count4 = sym.getVariable("count4");
         sym.setVariable("count4", count4 + 1 );
         if(count4 < 6) {
         	sym.play("start4");
         }
   ...
   (function(symbolName) {   
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 7000, function(sym, e) {
         var count5 = sym.getVariable("count5");
         sym.setVariable("count5", count5 + 1 );
         if(count5 < 6) {
         	sym.play("start5");
         }
